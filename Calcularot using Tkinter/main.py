...
class Calculator:
    def __init__(self, master):
        ...
        self.entry_value=''
        Entry(width=17,bg='#ccdd',font=('Arial Bold', 28), textvariable=self.equation).place(x=0,y=0)
        ...
        Button(width=11, height=4, text='=',relief='flat',bg='light blue', command=lambda:self.solve).place(x=270,y=125)
        Button(width=11, height=4, text='C',relief='flat', command=self.clear).place(x=0,y=550)
        Calculator()
